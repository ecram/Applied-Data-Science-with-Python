...
def answer_three():
    ...
    new_df['dif2'] = abs(new_df['Gold'] - new_df['Gold.1']) / new_df['Gold.2']
...
def answer_six():
    ...
    aux = census_df[(census_df['COUNTY'] != 0)].copy()
    new_sdf = aux[['STNAME','CENSUS2010POP']].copy()
...
def answer_seven():
    aux = census_df[(census_df['COUNTY'] != 0)]
    df7 = aux[['CTYNAME','POPESTIMATE2010','POPESTIMATE2011','POPESTIMATE2012','POPESTIMATE2013','POPESTIMATE2014','POPESTIMATE2015']].copy()
    df7 = df7.reset_index()
...
def answer_eight():
    ...
    return df8[['STNAME', 'CTYNAME']].copy()
answer_eight()

...
def degree_distribution(G):
    ...
    return histogram
print("P1_Graphs[0]: ", end=""); print(degree_distribution(P1_Graphs[0]), end="\n\n")
print("P1_Graphs[1]: ", end=""); print(degree_distribution(P1_Graphs[1]), end="\n\n")
print("P1_Graphs[2]: ", end=""); print(degree_distribution(P1_Graphs[2]), end="\n\n")
print("P1_Graphs[3]: ", end=""); print(degree_distribution(P1_Graphs[3]), end="\n\n")
print("P1_Graphs[4]: ", end=""); print(degree_distribution(P1_Graphs[4]), end="\n\n")


# In[4]:

print("P1_Graphs[0]: ", end=""); print(nx.average_clustering(P1_Graphs[0]))
print("P1_Graphs[1]: ", end=""); print(nx.average_clustering(P1_Graphs[1]))
print("P1_Graphs[2]: ", end=""); print(nx.average_clustering(P1_Graphs[2]))
print("P1_Graphs[3]: ", end=""); print(nx.average_clustering(P1_Graphs[3]))
print("P1_Graphs[4]: ", end=""); print(nx.average_clustering(P1_Graphs[4]))


# In[5]:

print("P1_Graphs[0]: ", end=""); print(nx.average_shortest_path_length(P1_Graphs[0]), len(degree_distribution(P1_Graphs[0])))
print("P1_Graphs[1]: ", end=""); print(nx.average_shortest_path_length(P1_Graphs[1]), len(degree_distribution(P1_Graphs[1])))
print("P1_Graphs[2]: ", end=""); print(nx.average_shortest_path_length(P1_Graphs[2]), len(degree_distribution(P1_Graphs[2])))
print("P1_Graphs[3]: ", end=""); print(nx.average_shortest_path_length(P1_Graphs[3]), len(degree_distribution(P1_Graphs[3])))
print("P1_Graphs[4]: ", end=""); print(nx.average_shortest_path_length(P1_Graphs[4]), len(degree_distribution(P1_Graphs[4])))
...
def ManagementSalary(node):
    mS = node[1]['ManagementSalary']
    if mS == 0:
        return 0
    elif mS == 1:
        return 1
...
def salary_predictions():
    ...
    df['is_management'] = pd.Series([ManagementSalary(node) for node in G.nodes(data=True)])
    ...
    return pd.Series(test,X_test.index)
...
df_cn_soundarajan_hopcroft.head(5)
...
def new_connections_predictions():
    ...
    test = clf.predict_proba(X_test_scaled)[:, 1]
    predictions = pd.Series(test,X_test.index)

...
def answer_one():
    ...
    data = np.bincount(df.Class)
    #print(data)
    return data[1]/len(df)
...
def answer_two():
    ...
    y_d_predic = dummy_majority.predict(X_test)
    
    return accuracy_score(y_test, y_d_predic), recall_score(y_test, y_d_predic)
